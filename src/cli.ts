...
function cmdAnalyze(flags: Record<string, string | boolean>): void {
  ...
  if (flags.demo) {
    ...
    console.error('Provide --demo or --input <analysis-input.json>. See README for the input schema.');
    process.exit(2);
    return;
  }
